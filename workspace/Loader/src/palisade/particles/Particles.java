...
public class Particles extends Activity implements Renderer.AnimationCallback
{
	GLSurfaceView mView;
	Renderer mRenderer;
	...
	private GLWorld makeGLWorld()
	{
		...
		try {
			mesh = new Object3D(world, "/sdcard/ball.obj", true);
		} catch (Exception e) {
			Log.d("Particles", e.toString());
		}
	...
	@Override protected void onCreate(Bundle savedInstanceState) {
		...
		mRenderer = new Renderer(makeGLWorld(), this);
